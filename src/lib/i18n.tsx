...
const dict: Record<Locale, Record<string, string>> = {
  ...
  id: {
    ...
    "abt.p1.bold": "Yovi Widianto",
    "abt.p1.rest": "dengan keyakinan bahwa produk yang baik tidak hanya harus berfungsi dengan baik, tetapi juga dibuat dengan perhatian terhadap kualitas dan detail. Berangkat dari pengalamannya melihat banyak tim berbakat menghasilkan produk yang belum sepenuhnya memaksimalkan potensinya, ia membangun sebuah studio yang tetap menjunjung tinggi craftsmanship dalam setiap prosesnya.",
    "abt.p2": 'Kami adalah tim desainer dan engineer yang selalu memulai dengan satu pertanyaan sederhana: "Apakah ini dapat membuat hari seseorang menjadi lebih baik?"',
    "abt.p2.bold": "",
    "abt.p2.end": `Nama Kaixin (开心) berarti "bahagia". Bagi kami, kebahagiaan bukan sekadar metrik atau fitur tambahan, melainkan tujuan utama yang menjadi dasar dalam merancang setiap pengalaman yang kami ciptakan.`,
